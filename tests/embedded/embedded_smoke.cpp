...
// preprocessor). Cortex-M0 compiles the empty primary template.
template <bool Enabled>
struct smoke_atomic_handle {};
template <>
struct smoke_atomic_handle<true> {
  metl::atomic_handle<metl::versioned_handle<struct smoke_handle_tag>> cell;
};
[[maybe_unused]] smoke_atomic_handle<
    metl::has_lock_free_handle_atomic_v<metl::versioned_handle<struct smoke_handle_tag>>> _atomic_handle;
